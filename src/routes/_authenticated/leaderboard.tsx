  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="text-center">
        ...
        <h1 className="mt-2 font-display text-3xl font-bold">Leaderboard</h1>
        <p className="mt-1 text-sm text-muted-foreground">Top cosmic traders, ranked by portfolio value (USD).</p>
      </div>
            ...
            {allUsers.map((u, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-3">${u.value.toLocaleString(undefined, { maximumFractionDigits: 0 })}</td>
                  <td className={`px-6 py-3 text-right font-medium ${returnPct >= 0 ? "text-success" : "text-destructive"}`}>
